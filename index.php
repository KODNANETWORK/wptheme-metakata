...
<div class="i-logo-div"><a href="<?php echo home_url(); ?>"><img src="<?php echo get_theme_mod('pdn_home_img_settings') ?>" class="i-custom-logo"></img></a></div>
...
<ul class="single-menu"><?php wp_nav_menu( array( 'theme_location' => 'single-menu' ) ); ?></ul>
</div>
</div>
